...
<div class="content">
<br>
<h2 ><b>SET TOP BOX DETAILS</b></h2>
<hr>

<button class="button"><a href="user5.php" class="text-light"><b>Add Details</b></a></button>
<table class="table table-striped">
  ...
  <tbody>
	...
	$sql="SELECT * from SETTUPBOX_DETAILS  " ;
	...
	if($result){
		while($row=mysqli_fetch_assoc($result)){
			...
			echo '<tr>
			  ...
			  <td>
			<button type="button" class="btn btn-danger" ><a href="update5.php?
			updateid='.$slno.'" class="text-light">Update</a></button>
			<button type="button" class="btn btn-danger" ><a href="delete5.php?
