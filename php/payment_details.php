...
<button class="button"><a href="user4.php" class="text-light"><b>Add Details</b></a></button>
	...
	if($result){
		while($row=mysqli_fetch_assoc($result)){
			...
			echo '<tr>
			  ...
			  <td>
			<button type="button" class="btn btn-danger" ><a href="update4.php?
			updateid='.$slno.'" class="text-light">Update</a></button>
			<button type="button" class="btn btn-danger" ><a href="delete4.php?
